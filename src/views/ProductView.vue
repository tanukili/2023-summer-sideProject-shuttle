    ...
    <div class="block-spacing-sm container">
            ...
            <div class="card-body pt-4">
              ...
              <ul class="list-group list-group-flush fs-8 pt-2">
                <li class="list-group-item bg-white py-1 border-0">
                  <span class="fw-bold">日期</span>&emsp;2023.08.19
                </li>
                <li class="list-group-item bg-white py-1 border-0">
                  <span class="fw-bold">時間</span>&emsp;13:00~16:00
                </li>
                <li class="list-group-item bg-white py-1 border-0">
                  <span class="fw-bold">名額</span>&emsp;15 位
                </li>
                <li class="list-group-item bg-white py-1 border-0">
                  <span class="fw-bold">使用技巧</span>&emsp;綴織
                </li>
                <li class="list-group-item bg-white py-1">
                  <span class="fw-bold">推薦對象</span>&emsp;無經驗者、親子
                </li>
              </ul>
            </div>
            <div class="card-footer pb-4">
              <div class="d-flex align-items-center mb-3">
                <small class="fs-5 fs-xl-4 fw-semibold text-danger"
                  >NT 850</small
                >
                <div class="d-flex align-items-center ms-auto">
                  ...
                  <div class="select-icon">
                    <select class="form-select form-select-sm fs-7 pe-4">
              ...
              <div class="row gx-2">
                ...
                <div class="col-lg-6">
                  <RouterLink
                    class="btn btn-primary rounded-1 fs-7 w-100"
                    to="/carts"
                  >
                    立即購買
                  </RouterLink>
      ...
      <ul class="nav nav-tabs" id="productTab" role="tablist">
        <li class="nav-item w-33 w-md-25 me-md-1" role="presentation">
          <button
            class="nav-link py-2 border-dashed fs-lg-6 w-100 active"
            id="introduction-tab"
            data-bs-toggle="tab"
        ...
        <li class="nav-item w-33 w-md-25 me-md-1" role="presentation">
          <button
            class="nav-link py-2 border-dashed fs-lg-6 w-100"
            id="precaution-tab"
            data-bs-toggle="tab"
      ...
      <div class="tab-content fs-8 fs-lg-7 p-4" id="productTabContent">
        <!-- 課程介紹內容 -->
        <div
        ...
        >
          <ul class="mb-0">
            <li class="my-1 my-md-2">輔助類課程屬於進階課程，故不建議初學者購買，推薦擁有手織經驗的學員參與。</li>
            <li class="my-1 my-md-2">上課空間有限，為保障學員們學習權益，請準時到達課程地點，以便充分利用課程時間。</li>
        ...
        <ul class="list-group list-group-flush">
            <li class="list-group-item bg-white py-2 my-md-2 border-bottom-base border-mellow">
              <span class="fw-bold lh-lg">Q. 課程購買後，能延後或取消課程嗎？
              </span><br>
              開課 7 日前可以免費調整課程時間或取消，7日內則需支付取消費用， 3 日前為課程費用 30% ， 1 日前為課程費用 50% 。
            </li>
            <li class="list-group-item bg-white py-2 my-md-2 border-bottom-base border-mellow">
              <span class="fw-bold lh-lg">Q. 錯過了這次報名時間，之後還會再開設課程嗎？
              </span><br>
              需要視課程類型而定，體驗類課程的開課間隔約 1 ~ 2 月；初學者課程的開課間隔約一季；進階課程則約一年 1 次。<br>
              開課標準會依課程熱門度進行調整，歡迎聯絡我們，告知您的需求。
            </li>
            <li class="list-group-item bg-white py-2 my-md-2 border-bottom-base border-mellow">
              <span class="fw-bold lh-lg">Q. 如果上課人數超過 10 人該如何報名？
              </span><br>
